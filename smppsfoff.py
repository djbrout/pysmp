...
class smp:
    ...
    def main(self,nodiff=False,nozpt=False,rootdir='',outdir='' ,
        ...
        smp_dict = {'scale':np.zeros(snparams.nvalid),
                    ...
                    'descriptiveflag': np.ones(snparams.nvalid)+65535,
            ...
            if nozpt:
                ...
                if not skipactualzeropoint:
                    ...
                    if snparams.psf_unit.lower() == 'arcsec':
                        fwhm_arcsec = fwhm
                    elif snparams.psf_unit.lower().startswith('sigma-pix') or snparams.psf_unit.lower().startswith(
                            'pix'):
                    ...
                    zpt,zpterr,zpt_file, rmsaddin, thisra,thisdec, thisids,zptfitchisq = self.getzpt(x_star1,y_star1,tras,tdecs,tids,mag,sky,skyerr,snparams.mjd[j],
                                         ...
                                         longimfile,bkgrnd,bkgrndrms,fwhm_arcsec,psf=self.psf,mjd=str(float(snparams.mjd[j])),gain=self.gain)
        ...
        for im,m,fl,k in zip(smp_dict['image_filename'],smp_dict['mjd'],smp_dict['flag'],range(len(smp_dict['image_filename']))):
            ...
            if fl != 1:
                ...
                if k <= 40:
                    ...
                    ax.axhline(0, c='k')
                    ax.axvline(0, c='k')
                    ax.axvline(smp_dict['yoff'][k],c='red')
                    ax.axhline(smp_dict['xoff'][k],c='red')
                    ax.legend()
    ...
    def getzpt(self,xstar,ystar,ras, decs,ids,mags,sky,skyerr,thismjd,
                ...
                mjdoff,mjdslopeinteroff,j,longimfile,bkgrnd,bkgrndrms,fwhm,psf='',mjd=None,
