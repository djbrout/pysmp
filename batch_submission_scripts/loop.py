...
outdir = '/project/projectdirs/des/djbrout/specv1_1'
...
for i in allindexes:
    for filt in filts:
        ...
        f.write(
            ...
            '#SBATCH --output=/global/cscratch1/sd/dbrout/logs/' + str(i) + '_'+filt+'spec2.log\n' +
            '#SBATCH --error=/global/cscratch1/sd/dbrout/logs/' + str(i) + '_'+filt+'spec2.log\n' +
