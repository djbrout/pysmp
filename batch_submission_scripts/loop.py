...
for i in allindexes:
    ...
    f.write(
        ...
        '#SBATCH --output=/global/cscratch1/sd/dbrout/logs/sm_' + str(i) + '_v1gsim.log\n' +
        '#SBATCH --error=/global/cscratch1/sd/dbrout/logs/sm_' + str(i) + '_v1gsim.log\n' +
        '#SBATCH --job-name=sim_gband_' + str(i) + '\n' +
