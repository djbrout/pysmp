...
for i in allindexes:
    for filt in filts:
        ...
        f.write(
            ...
            '#SBATCH --output=/global/cscratch1/sd/dbrout/logs/' + str(i) + '_'+filt+'sim2d.log\n' +
            '#SBATCH --error=/global/cscratch1/sd/dbrout/logs/' + str(i) + '_'+filt+'sim2d.log\n' +
            '#SBATCH --job-name=smd_'+filt+'_' + str(i) + '\n' +
