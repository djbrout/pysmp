...
if __name__ == "__main__":
    ...
    resultsdir = '/project/projectdirs/des/djbrout/v64shift/'
    #resultsdir= './working/'
    #resultsdir= '/export/scratch0/ps1sn1/data/v10.0/GPC1v3/eventsv1/smpworkspace/PS_TEST1/'
    #resultsdir = './workingsimnosn'
    isfermigrid = False
    cacheddata = False
    cd = '/project/projectdirs/des/djbrout/v64shift//summary_results.npz'
    ...
    print filter
    cd = '/project/projectdirs/des/djbrout/v64shift/summary_results_'+filter+'.npz'
