...
def plotsigmaresid(flux,fluxerr,fakemag,fitzpt,fakezpt,hostmag,chisqarr,rmsaddin,deep,outdir):
    ...
    ww = (flux != 0) & (np.array(fakemag,dtype='float') > 90.) & (fluxerr >0.) & (np.isfinite(flux)) & (np.isfinite(fluxerr))
...
if __name__ == "__main__":
    ...
    isfermigrid = False
    cacheddata = False
    cd = '/project/projectdirs/des/djbrout/v62shift//summary_results.npz'
