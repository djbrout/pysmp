    ...
    def __init__(self
        ...
        if os.path.exists(chainsnpz):
            ...
            try:
                ...
                self.xhistory = np.load(chainsnpz)['xhistory'].tolist()[-1000:]
                self.yhistory = np.load(chainsnpz)['yhistory'].tolist()[-1000:]
            except:
                os.remove(chainsnpz)
                pass

            #print self.modelvec.shape, diffim_flux.shape
        ...
        print len(self.modelvec),len(self.modelstd)
        ...
        for i, p in enumerate(psfs):
            try:
                print self.modelstd[i], self.flags[i], fwhm(p)
                # fwhms.append(dt.fwhm(p))
            except:
                # fwhms.append(999)
                print 'nan'
        # raw_input()
        #print 'ffffss',self.flags
    ...
    def run_d_mc(self):
        ...
        while self.z_scores_say_keep_going:
            ...
            if (self.counter % 1000) == 0:
                ...
                #print 'chisqcheck',chsqs[chsqs != 0.]
